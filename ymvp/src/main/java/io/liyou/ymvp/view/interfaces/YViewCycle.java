...
package io.liyou.ymvp.view.interfaces;
 ...
 */
public interface YViewCycle<T extends YBasePresenter> {
     ...
     * 在 {@link #onBeforeCreate }之后被调用 <br /> will be called after {@link #onBeforeCreate } called
     *
     ...
     * 在 {@link #onInit()} 之后被调用 <br /> will be called after {@link #onInit()} called
     */
    void onListener();
